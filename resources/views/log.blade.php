...
*/
    ...
    <style>
        #frame-0 .hljs-ln-line[data-line-number='175'] {
                ...
                <section
                    ...
                    Error
                            ...
                            <div
                                ...
                                Class &quot;App\Http\Controllers\Api\v1\Carbon&quot; not found
                            </div>
                        </div>
...
require $frontControllerPath;
                ...
                <section
                    ...
                    <div class="mt-2">
                        <span>POST</span>
                        <span class="text-gray-500">/api/v1/messages/119/hide</span>
                    </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">104148d3-6e06-46bd-9dee-40d3b54ccb60</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">Bearer 57|GDBb6ZEDegjuQ2UlTEIXbbmi7E61wIXizBOlDsHJf535ef8a</code></pre>
                </span>
                        </div>
                    </dl>
            ...
            >
                ...
                <section
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">App\Http\Controllers\Api\V1\MessageController@hide</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
    ...
    &quot;id&quot;: &quot;119&quot;
                    ...
                    <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                        <div class="flex items-center gap-2  dark:border-gray-800">
                            <div
                                ...
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(18.72 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `personal_access_tokens` where `personal_access_tokens`.`id` = &#039;57&#039; limit 1</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(2.41 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                ...
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `users` where `users`.`id` = 9 limit 1</code></pre>
                        ...
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(8.47 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">update `personal_access_tokens` set `last_used_at` = &#039;2025-06-26 16:27:30&#039;, `personal_access_tokens`.`updated_at` = &#039;2025-06-26 16:27:30&#039; where `id` = 57</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(0.72 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `messages` where `messages`.`id` = &#039;119&#039; limit 1</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(0.56 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select exists(select * from `deleted_messages` where `messages_id` = 119 and `users_id` = 9) as `exists`</code></pre>
                </span>
                        </div>
                    </dl>
                </section>
