...
*/
    ...
    <style>
        #frame-0 .hljs-ln-line[data-line-number='1019'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-1 .hljs-ln-line[data-line-number='890'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-2 .hljs-ln-line[data-line-number='1077'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-3 .hljs-ln-line[data-line-number='821'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-4 .hljs-ln-line[data-line-number='1057'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-5 .hljs-ln-line[data-line-number='286'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-7 .hljs-ln-line[data-line-number='211'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-10 .hljs-ln-line[data-line-number='50'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-12 .hljs-ln-line[data-line-number='26'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-13 .hljs-ln-line[data-line-number='169'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-14 .hljs-ln-line[data-line-number='126'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-15 .hljs-ln-line[data-line-number='25'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-17 .hljs-ln-line[data-line-number='126'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-22 .hljs-ln-line[data-line-number='200'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-23 .hljs-ln-line[data-line-number='169'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-32 .hljs-ln-line[data-line-number='109'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-34 .hljs-ln-line[data-line-number='61'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-40 .hljs-ln-line[data-line-number='26'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-41 .hljs-ln-line[data-line-number='208'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-42 .hljs-ln-line[data-line-number='126'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-43 .hljs-ln-line[data-line-number='175'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-44 .hljs-ln-line[data-line-number='144'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-45 .hljs-ln-line[data-line-number='1219'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-46 .hljs-ln-line[data-line-number='20'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-47 .hljs-ln-line[data-line-number='139'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
    </style>
</head>
            ...
            <div class="container mx-auto">
                <section
                    ...
                    POST k22cnt3_project4_minichat.test
                            ...
                            <div class="px-4">
                                <span class="text-sm text-gray-500 dark:text-gray-400">PHP 8.4.7 — Laravel 12.16.0</span>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Container\Container</span>
                                    <span class="font-mono text-xs">:1019</span>
                                </span>
                            </div>
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Container\Container</span>
                                    <span class="font-mono text-xs">:890</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                resolve
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    ...
                                    <span class="font-mono text-xs">:1077</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                resolve
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Container\Container</span>
                                    <span class="font-mono text-xs">:821</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                make
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Foundation\Application</span>
                                    <span class="font-mono text-xs">:1057</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                make
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    ...
                                    <span class="font-mono text-xs">:286</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                getController
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Users\lasng\Herd\k22cnt3_project4_minichat\vendor\laravel\framework\src\Illuminate\Container\Container.php</span>
...
require $frontControllerPath;
                ...
                <section
                    ...
                    <div class="mt-2">
                        <span>POST</span>
                        <span class="text-gray-500">/api/register</span>
                    </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">190</code></pre>
                </span>
                        </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">a7e25287-a7c1-4b8f-8280-6ab99ac00ef5</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
    ...
    &quot;avatar&quot;: &quot;https://example.com/avatar.jpg&quot;
                ...
                <section
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">AuthController@register</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
