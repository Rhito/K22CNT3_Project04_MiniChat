...
*/.hljs{color:#24292e;background:#fff}.hljs-doctag,.hljs-keyword,.hljs-meta .hljs-keyword,.hljs-template-tag,.hljs-template-variable,.hljs-type,.hljs-variable.language_{color:#d73a49}.hljs-title,.hljs-title.class_,.hljs-title.class_.inherited__,.hljs-title.function_{color:#6f42c1}.hljs-attr,.hljs-attribute,.hljs-literal,.hljs-meta,.hljs-number,.hljs-operator,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-id,.hljs-variable{color:#005cc5}.hljs-meta .hljs-string,.hljs-regexp,.hljs-string{color:#032f62}.hljs-built_in,.hljs-symbol{color:#e36209}.hljs-code,.hljs-comment,.hljs-formula{color:#6a737d}.hljs-name,.hljs-quote,.hljs-selector-pseudo,.hljs-selector-tag{color:#22863a}.hljs-subst{color:#24292e}.hljs-section{color:#005cc5;font-weight:700}.hljs-bullet{color:#735c0f}.hljs-emphasis{color:#24292e;font-style:italic}.hljs-strong{color:#24292e;font-weight:700}.hljs-addition{color:#22863a;background-color:#f0fff4}.hljs-deletion{color:#b31d28;background-color:#ffeef0}
    ...
    <style>
                    #frame-0 .hljs-ln-line[data-line-number='25'] {
    ...
    <div class="md:flex md:items-center md:justify-between md:gap-2">
        <div class="min-w-0">
            ...
            <div class="mt-4 text-lg font-semibold text-gray-900 break-words dark:text-white lg:text-2xl">
                Class &quot;App\Http\Controllers\Api\V1\Message&quot; not found
            </div>
        </div>
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">C:\Users\lasng\Herd\k22cnt3_project4_minichat\app\Http\Controllers\Api\V1\ConversationController.php</span>
        ...
        <div class="mb-3">
            <div class="text-md text-gray-500 dark:text-gray-400">
                <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Users\lasng\Herd\k22cnt3_project4_minichat\app\Http\Controllers\Api\V1\ConversationController.php</span>
...
>
    ...
    <div class="mt-2">
        <span>GET</span>
        <span class="text-gray-500">/api/v1/conversation</span>
    </div>
    ...
    <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                ...
                <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">971568e4-99fb-43f2-a9e4-21a0dba6c55b</code></pre>
                </span>
            </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
...
>
    ...
    <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                ...
                <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">App\Http\Controllers\Api\V1\ConversationController@getAll</code></pre>
                </span>
            </div>
                    <div class="flex items-center gap-2 border-t dark:border-gray-800">
                <span
    ...
    <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                ...
                <div class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                    <span>mysql</span>
                    <span class="hidden text-xs text-gray-500 lg:inline-block">(4.13 ms)</span>
                </div>
                <span
                    class="min-w-0 flex-grow"
                    style="
                ...
                <div class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                    <span>mysql</span>
                    <span class="hidden text-xs text-gray-500 lg:inline-block">(7.83 ms)</span>
                </div>
                <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">update `personal_access_tokens` set `last_used_at` = &#039;2025-06-26 08:10:36&#039;, `personal_access_tokens`.`updated_at` = &#039;2025-06-26 08:10:36&#039; where `id` = 57</code></pre>
                </span>
            </div>
            </dl>
</section>
